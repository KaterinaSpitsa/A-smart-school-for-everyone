...
Μέσω αυτής, οι μαθητές θα σχεδιάσουν ένα σχολείο για όλους, θα καταγράψουν τις ανάγκες αλλά και τις παροχές που πρέπει να διαθέτει. Θα γίνει, αρχικά, μια ανίχνευση πρότερων γνώσεων των παιδιών για το τι σημαίνει αειφόρο σχολείο. Θα γίνει αναζήτηση στο διαδίκτυο των εφαρμογών τεχνητής νοημοσύνης που βοηθούν στην κατεύθυνση αυτή. Στη συνέχεια θα σχεδιαστεί το σχολείο και θα αξιοποιηθούν τα υλικά που προτείνονται παρακάτω. Κατά τη διάρκεια του σχεδιασμού, θα ενισχυθεί η μαθησιακή διαδικασία καθώς μέσα από αυτή τα παιδιά συνεργάζονται, διερευνούν, ασκούν κριτική και εκφράζουν απόψεις σε ποικίλα προβλήματα προς επίλυση, αξιοποιώντας προσωπικά βιώματα και εμπειρίες.
